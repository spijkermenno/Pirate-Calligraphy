...
public class Compiler {
	...
	private CommonTokenStream runLexer( CharStream input ) {
		ZegMakkerScriptLangLexer lexer = new ZegMakkerScriptLangLexer(input);  // TODO: Replace lexer with the one for your own language
	...
	private ParseTree runParser( CommonTokenStream tokens ) {
		ZegMakkerScriptLangParser parser = new ZegMakkerScriptLangParser(tokens);  // TODO: Replace parser with the one for your own language
		parser.addErrorListener(getErrorListener());
		return parser.parse();                                   // TODO: Replace .program() with your own start symbol
	}
	...
	private boolean runChecker( ParseTree parseTree ) {
		// TODO: Create your own checker that inherits from a BaseVisitor, e.g. ZegMakkerScriptLangBaseVisitor.
	...
	private JasminBytecode generateCode( ParseTree parseTree, String className ) {
		...
		jasminBytecode.add(".class public zsm");
